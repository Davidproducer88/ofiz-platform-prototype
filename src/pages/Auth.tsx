...
const Auth = () => {
  ...
  if (showEmailVerification && pendingEmail) {
    return <EmailVerificationNotice email={pendingEmail} onBack={handleBackFromVerification} />;
  }
    ...
    return <div className="min-h-screen bg-gradient-to-br from-primary/20 via-background to-secondary/20 flex items-center justify-center p-4">
        <div className="w-full max-w-4xl relative">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-foreground mb-2">¡ Sumate a Ofiz !</h1>
        ...
        <CardContent>
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="signup" className="space-y-4">
              ...
              {selectedUserType ? <SignUpForm userType={selectedUserType} onBack={() => setSelectedUserType(null)} onEmailVerification={handleEmailVerificationShow} /> : <div className="text-center">
                  <p className="text-sm text-muted-foreground mb-4">
                    Para registrarte, primero elige tu tipo de cuenta
                  </p>
                  <button onClick={handleSignUpClick} className="w-full bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2 rounded-md font-medium transition-colors">
